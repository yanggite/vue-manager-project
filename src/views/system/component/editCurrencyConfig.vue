<template>
    <div class="editCurrencyConfig dialogSingle">
        <el-dialog title="编辑币种  " :visible.sync="CVisible" width="500px">
            <el-form :model="form" :rules="rules" ref="form" :label-position="labelPosition" label-width="120px">
                <el-form-item label="币种名称" prop="coinName">
                    <el-input v-model="form.coinName" autocomplete="off" class="inputPure"></el-input>
                </el-form-item>
                ...
                <!-- <el-form-item label="usdt交易对价格" prop="usdtUnit">
                    <el-input v-model="form.usdtUnit" autocomplete="off" class="inputPure"></el-input>
                </el-form-item> -->
                ...
                <el-form-item label="是否允许提币" prop="isApply">
                    <el-select v-model="form.isApply" placeholder="请选择" class="editSelect">
                        <el-option label="是" :value="1"></el-option>
                        <el-option label="否" :value="0"></el-option>
                    </el-select>
                </el-form-item>
                <div v-if="this.form.isApply == '1'">
                    <el-form-item label="起提数量" prop="lowWidthdrawNum">
                        <el-input v-model="form.lowWidthdrawNum" autocomplete="off" class="inputPure"></el-input>
                    </el-form-item>
                    <el-form-item label="提币倍数" prop="widthdrawBs">
                        <el-input v-model="form.widthdrawBs" autocomplete="off" class="inputPure"></el-input>
                    </el-form-item>
                    <el-form-item label="提币手续费比例" prop="widthdrawFree">
                        <el-input v-model="form.widthdrawFree" autocomplete="off" class="inputPure"></el-input>
                    </el-form-item>
                    <el-form-item label="提币手续费最小值" prop="lowFree">
                        <el-input v-model="form.lowFree" autocomplete="off" class="inputPure"></el-input>
                    </el-form-item>
                    <el-form-item label="提币手续费最大值" prop="upFree">
                        <el-input v-model="form.upFree" autocomplete="off" class="inputPure"></el-input>
                    </el-form-item>
                </div>
                <el-form-item label="是否允许内部转账" prop="isInternalTransfer">
                    <el-select v-model="form.isInternalTransfer" placeholder="请选择" class="editSelect">
                        <el-option label="是" :value="1"></el-option>
                        <el-option label="否" :value="0"></el-option>
                    </el-select>
                </el-form-item>
                <div v-if="this.form.isInternalTransfer == '1'">
                    <el-form-item label="起转数量" prop="lowTransferNum">
                        <el-input v-model="form.lowTransferNum" autocomplete="off" class="inputPure"></el-input>
                    </el-form-item>
                ...
                <el-form-item label="重新上传logo图片" prop="logoUrl">
                    <div>
                        <el-upload
                            :limit="1"
                            :action="logoUrl"
...
export default {
    ...
    computed: {
        CVisible: {
            get() {
                return this.editCurrencyConfigVisible;
            },
            set(val) {
                this.$emit('update:editCurrencyConfigVisible', val);
            }
        },
        type: function() {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                // logoUrl: [{ required: true, message: 'logo', trigger: 'blur' }]
            },
            isUpdate: '',
    ...
    methods: {
        ...
        onCancle() {
            this.$emit('update:editCurrencyConfigVisible', false);
        },
        onSumbit() {
            this.$refs.form.validate(async valid => {
                if (valid) {
                    // this.$emit('update:editCurrencyConfigVisible', false);
                    const res = await this.$api.editCoinConfig(this.form);
                    console.log(res);
                    if (res.code === '200') {
